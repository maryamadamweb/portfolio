      ...
      <div className={styles.row}>
        ...
        <div className={styles.textPane}>
          ...
          <p className={styles.bio}>
            ...
            designer with a BA in Graphic Communication Design.
          </p>
          <p className={styles.bio}>
            Her work explores themes of heritage, introspection, and the
            connection between the conscious and unconscious. Community
            engagement is central to her practice, and she values the
            relationships formed with audiences through her concepts. Often
