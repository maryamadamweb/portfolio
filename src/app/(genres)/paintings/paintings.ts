...
export const paintings: Painting[] = [
  ...
  },
  {
    ...
    width: 1280,
    height: 1600,
    name: "From my mothers Hands",
    subtitle: "Embroidery piece",
    about:
      "Part of the wider project, using indeginous stitches style within embroidery pieces to recreate a memory from my mothers time in Gujarat",
  },
  {
    ...
    about:
      "A commission for a client, the brief was to focus on the client's mother, grief, vibrant colours, a plum orchid, and her foggy morning walks — tied together with the quote 'With every hardship comes ease.'",
  },
];
